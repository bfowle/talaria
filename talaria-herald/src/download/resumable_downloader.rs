...
impl ResumableDownloader {
    ...
    pub fn with_storage(mut self, storage: HeraldStorage, operation_id: String) -> Self {
...
mod tests {
    ...
    fn test_resumable_downloader_with_storage() -> Result<()> {
        ...
        let client = reqwest::Client::new();
        let storage = crate::storage::HeraldStorage::new(temp_dir.path())?;
