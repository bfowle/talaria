...
/// Content-addressed storage implementation for HERALD
use crate::types::*;
...
impl HeraldStorage {
    pub fn new(base_path: &Path) -> Result<Self> {
        ...
        // HERALD Principle #1: Single shared location for all sequences
    ...
    async fn fetch_single_chunk_static(
        ...
        let remote_base = std::env::var("TALARIA_REMOTE_REPO")
            .unwrap_or_else(|_| "https://herald.talaria.org".to_string());
...
// Trait implementations for HeraldStorage
impl ChunkStorage for HeraldStorage {
...
impl ManifestStorage for HeraldStorage {
...
impl DeltaStorage for HeraldStorage {
...
impl StateManagement for HeraldStorage {
...
mod tests {
    ...
    fn create_test_storage() -> (HeraldStorage, TempDir) {
    ...
    fn test_herald_storage_init() {
        ...
        let storage = HeraldStorage::new(temp_dir.path());
