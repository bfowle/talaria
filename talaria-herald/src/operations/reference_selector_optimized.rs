...
/// Graph centrality-based reference selection as specified in HERALD architecture
...
impl OptimizedReferenceSelector {
    pub fn new() -> Self {
        Self {
            ...
            parallel_taxa: true,
            max_index_size: None,
            // HERALD architecture-specified weights
    ...
    /// Select references using graph centrality metrics as per HERALD architecture
