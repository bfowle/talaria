/// Processing state management for resumable HERALD operations
///
/// This module tracks the state of ongoing HERALD operations (downloads, chunking, updates)
...
/// State tracking for HERALD processing operations
