...
fn tree_section(title: &str, items: Vec<(&str, String)>, _indent: bool) {
    log_info!("{}", title);
...
pub enum SelectionAlgorithm {
    ...
    Hybrid,
    /// Graph centrality-based algorithm (HERALD architecture specification)
...
impl ReferenceSelectorImpl {
    ...
    pub fn select_references_with_lambda(
        ...
        match self.selection_algorithm {
            ...
            SelectionAlgorithm::GraphCentrality => {
                // Use graph centrality approach from HERALD architecture
                fn info(msg: &str) {
                    tracing::info!("{}", msg);
                }
                info("Using graph centrality-based selection (HERALD 5-dimensional)");
    ...
    /// Graph centrality-based selection algorithm from HERALD architecture
    ...
    fn select_with_graph_centrality(
        ...
        section_header("Graph Centrality Algorithm (HERALD)");
