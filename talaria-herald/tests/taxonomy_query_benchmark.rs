...
///
/// Target from HERALD_REFACTOR_PLAN.md: Query "all bacterial proteins" in <1 second
use talaria_herald::{indices::SequenceIndices, taxonomy_filter::TaxonomyFilter, types::*};
