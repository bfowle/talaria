...
impl Default for WorkspaceConfig {
    fn default() -> Self {
        ...
        Self {
            sequoia_root: talaria_core::paths::talaria_workspace_dir(),
...
pub fn list_workspaces(config: &WorkspaceConfig) -> Result<Vec<WorkspaceMetadata>> {
    ...
    let preserved_dir = talaria_core::paths::talaria_databases_dir().join("preserved");
...
pub fn find_workspace(id: &str, config: &WorkspaceConfig) -> Result<Option<PathBuf>> {
    ...
    let preserved_path = talaria_core::paths::talaria_databases_dir()
        .join("preserved")
        .join(id);
    if preserved_path.exists() {
...
mod tests {
    ...
    fn test_workspace_uses_correct_directory() {
        ...
        let default_dir = talaria_core::paths::talaria_workspace_dir();
