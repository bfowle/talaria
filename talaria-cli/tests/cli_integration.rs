...
fn test_cli_help_command() {
    ...
    cmd.assert()
        ...
        .stdout(predicate::str::contains(
            "Talaria reduces biological sequence databases",
        ))
...
fn test_reduce_basic_workflow() -> Result<()> {
    ...
    assert!(
        ...
        "Output should have fewer or equal sequences"
    );
