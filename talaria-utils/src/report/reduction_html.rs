...
// Temporary - will be properly imported from talaria-sequoia
#[derive(Debug, Clone)]
pub struct SelectionResult {
    pub references: Vec<talaria_bio::Sequence>,
    pub deltas: HashMap<String, Vec<u8>>,
    pub children: HashMap<String, Vec<String>>,
    pub discarded: Vec<talaria_bio::Sequence>,
}
use anyhow::Result;
