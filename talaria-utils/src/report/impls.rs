...
impl HtmlReporter {
    ...
    fn generate_css(&self) -> &str {
        match self.theme.as_str() {
            "dark" => include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/assets/dark-theme.css")),
            _ => include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/assets/light-theme.css")),
        }
    }

    fn generate_js(&self) -> &str {
        include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/assets/report-interactive.js"))
    }
}
