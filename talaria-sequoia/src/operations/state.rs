/// Processing state management for resumable SEQUOIA operations
///
/// This module tracks the state of ongoing SEQUOIA operations (downloads, chunking, updates)
...
/// State tracking for SEQUOIA processing operations
