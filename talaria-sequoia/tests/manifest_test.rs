...
fn test_manifest_with_discrepancies() {
    use talaria_sequoia::types::TaxonomicDiscrepancy;
    ...
    manifest.discrepancies = vec![TaxonomicDiscrepancy {
        ...
        discrepancy_type: talaria_sequoia::types::DiscrepancyType::Conflict,
    }];
...
fn test_manifest_format_detection() {
    use talaria_sequoia::format::FormatDetector;
