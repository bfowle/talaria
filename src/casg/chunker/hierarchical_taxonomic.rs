...
/// Hierarchical taxonomic chunking as specified in CASG architecture
...
/// Hierarchical taxonomic chunker implementing CASG 5-dimensional approach
...
impl HierarchicalTaxonomicChunker {
    ...
    pub fn chunk_hierarchically(&self, sequences: Vec<Sequence>) -> Result<Vec<HierarchicalChunk>> {
        println!("Performing hierarchical taxonomic chunking (CASG 5-dimensional)");
