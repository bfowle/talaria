/// CASG-based reduction manifest and management
///
...
/// Manager for reduction operations in CASG
pub struct ReductionManager {
    storage: crate::casg::CASGStorage,
}

impl ReductionManager {
    pub fn new(storage: crate::casg::CASGStorage) -> Self {
        Self { storage }
    }
