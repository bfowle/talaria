...
impl StatsTable {
    ...
    pub fn add_metric_with_unit(&mut self, name: &str, value: u64, unit: &str, percentage: Option<f64>) {
...
pub fn create_validation_stats(
    ...
    table.add_metric_with_unit("Sequence coverage", covered_sequences as u64, "", Some(sequence_coverage * 100.0));
    table.add_metric_with_unit("Taxonomic coverage", covered_taxa as u64, "", Some(taxonomic_coverage * 100.0));
